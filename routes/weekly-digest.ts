 ...
 *
 * This is the showcase's proof that the platform hosts ordinary automation
  ...
  .transform((body) => {
    ...
    return {
      ...
      body: [
        ...
        "",
        "Generated by the Craft Showcase digest route. No agent was involved.",
      ].join("\n"),
    };
  })
  // Through the capability, not straight at the adapter. Every outbound mail
  // in the showcase passes the same scope check, so "mail:send is minted in one
